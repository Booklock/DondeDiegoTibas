...
export function ColillaPago({ empleado, dias, turnoMap, semanaInicio, onClose }) {
  ...
  const brutoPago  = totalOrdM + totalExtM
        ...
        <div className="px-8 py-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6 p-4 bg-gray-50 rounded-xl">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">{fmt(hHora)}/h (base÷30÷8)</p>
            </div>
          </div>
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden">
            <div className="bg-gray-50 px-5 py-2 border-b border-gray-200">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Resumen de pago</p>
            </div>
