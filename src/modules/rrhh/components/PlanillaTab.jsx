          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {empleadosFiltrados.map(emp => {
                ...
                const horasExtraFeriadoOT = horasExtraMap[emp.id]?.horas_feriado_ot ?? 0
                const { hrs_total, hrs_ot, hrs_ot_feriado, hrs_feriado, pago } = calcPago(emp, dias, turnoMap, horasExtraOT, horasExtraFeriadoOT)
